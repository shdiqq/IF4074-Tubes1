...
from stage.PoolingStage import PoolingStage
...
def main() :
  ...
  print(outputDetector.shape)
  print("===========")

  poolingStage = PoolingStage(filterSize = 3, stride = 1, mode='max')
  outputPooling = poolingStage.forward(output)

  print("Setelah pooling stage")
  print(outputPooling.shape)
  print("===========")
